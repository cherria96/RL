...
from models import PatchFormer_pretrain, PatchFormer_finetune, MultiDatasetWrapper
# from kan import KAN
...
class Exp_Main(Exp_Basic):
    ...
    def _build_model(self):
        model_dict = {
            'PatchFormer_pretrain':PatchFormer_pretrain,
    ...
    def _get_data(self, flag):
        feature_dims, data_loader = data_provider(self.args, flag)
        return feature_dims, data_loader
    ...
    def train(self, setting):
        train_data, train_loader, feature_dims = self._get_data(flag='train')
        vali_data, vali_loader, _ = self._get_data(flag='val')
        test_data, test_loader, _ = self._get_data(flag='test')
        self.model = MultiDatasetWrapper(self.model, feature_dims, shared_input_dim = self.args.enc_in).to(self.device)
